       ...
       // $user = $this->security->getUser();
        ...
        return [
           ...
           // TextField::new('fechaRegistroTexto', 'Fecha Registro')->hideOnIndex(), //->setFormat('dd/MMMM/yyyy'),
            ...
            TextField:: new('fechaPagoTexto','Fecha de Pago Multa')->hideOnForm(),
            ...
            //DateField::new('fechaPago', 'Fecha de Pago')->setFormat('dd/MMMM/yyyy')->hideOnForm(),
