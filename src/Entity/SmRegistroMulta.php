...
class SmRegistroMulta
{
    ...
    public function __construct()
    {
        ...
        //$this->fechaPagoMulta = new \DateTime();
    }
...
/*
    public function getFechaPagoMulta(): ?\DateTimeInterface
    {
        return $this->fechaPagoMulta;
    }

    public function setFechaPagoMulta(\DateTimeInterface $fechaPagoMulta): self
    {
...
*/
    ...
    public function setSmUsuario(?SmUsuario $smUsuario): self
    {
     ...
     public function setFechaPagado(?date $fecha): self
    {
        $this->getFechaPagado = $fecha;
    ...
    private $fechaPago;
     ...
     public function getFechaPagoTexto(): ?string
     {
         $fecha ="";
         if($this -> getFechaPago() != null){
            $fecha = $this -> getFechaPago() ->format('d/m/Y');  
         }
         return $fecha;
     }
